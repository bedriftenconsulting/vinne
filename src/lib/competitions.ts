...
export const competitions: Competition[] = [
  ...
  },
  {
    ...
    endsAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000),
    tag: "Coming Soon",
    description: "Win GHS 50,000 cash deposited directly to your mobile money account!",
  },
  {
    id: "ps5-bundle",
...
export const winners = [
  ...
  { name: "Ama D.", prize: "GHS 10,000 Cash", ticket: "WBX-73920", date: "Mar 25, 2026" },
