...
# Try issuing a ticket with a fake schedule ID
$ticketBody = @{
    game_code = "PS5DRAW"
    game_schedule_id = "direct-ef6b4f8a-9023-442c-aaa6-40b5a7e2f791"
    draw_number = 1
    selected_numbers = @()
    bet_lines = @(@{
        line_number = 1
    ...
    customer_phone = "+233256826832"
    customer_name = "Suraj Mohammed"
    payment_method = "mobile_money"
    payment_ref = "manual-test-123"
